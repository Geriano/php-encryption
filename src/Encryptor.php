...
namespace Geriano\Encryption;

use Geriano\Encryption\Exceptions\EncryptException;
use Geriano\Encryption\Exceptions\DecryptException;
use Geriano\Encryption\Exceptions\CipherKeyException;
